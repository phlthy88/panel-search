...
1. Copy the extension directory to GNOME Shell extensions folder:
   ```bash
   cp -r panel-search@jlf88 ~/.local/share/gnome-shell/extensions/
   ```

2. Compile the GSettings schema:
   ```bash
   cd ~/.local/share/gnome-shell/extensions/panel-search@jlf88
...
4. Enable the extension:
   ```bash
   gnome-extensions enable panel-search@jlf88
   ```
...
```bash
gnome-extensions prefs panel-search@jlf88
```
